...
Try {
	...
	[string]$appVendor = ''
	[string]$appName = 'Restart Required'
	[string]$appVersion = ''
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.5.5'
	[string]$appScriptDate = '11/30/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Show-InstallationWelcome -CloseApps 'iexplore2' -AllowDefer -DeferDays 5 -PersistPrompt
        		
		## Show Progress Message (with the default message)
		#Show-InstallationProgress
		
		## <Perform Pre-Installation tasks here>
		#Show-InstallationPrompt -Message 'TriNet IT is about to restart your Computer. Please save all your work and click Continue'-PersistPrompt -Icon Warning -ButtonMiddleText 'Continue'
