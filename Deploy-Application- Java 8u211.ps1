...
Try {
	...
	[string]$appName = 'Java'
	[string]$appVersion = '8u211'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.1.0'
	[string]$appScriptDate = '04-22-2019'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## Show Welcome Message, close Internet Explorer if required, allow up to 3 deferrals, verify there is enough disk space to complete the install, and persist the prompt
				Show-InstallationWelcome -CloseApps 'java,javaw,javaws,iexplore,safari,opera' -Silent -BlockExecution -CheckDiskSpace -PersistPrompt

		## Show Progress Message (with the default message)
		Show-InstallationProgress
		Show-InstallationPrompt -Message "This Application will update Java to version $appVersion. Please save all your work and click Continue"-PersistPrompt -Icon Warning -ButtonMiddleText 'Continue'
    ...
    #Perform WMI query to find installed Java Updates (64-bit)
        ...
        Write-Log "Installing New Java version $appVersion"

		## <Perform Installation tasks here>
                Show-InstallationProgress "All previous version of Java have been removed. Now updating Java to $appVersion. Please wait..."
		...
		Set-RegistryKey -Key 'HKEY_LOCAL_MACHINE\SOFTWARE\TriNet' -Name "$appVendor`_$AppName`_$AppVersion" -Value '0' -Type String -ContinueOnError:$True
		##*===============================================
		##* POST-INSTALLATION
		##*===============================================
		...
		If (-not $useDefaultMsi) { Show-InstallationPrompt -Message "Java has been upgraded to $appVersion" -ButtonRightText 'OK' -Icon Information -NoWait }
	    Write-Log "Java $appVersion Install Complete"
        }
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Set-RegistryKey -Key 'HKEY_LOCAL_MACHINE\SOFTWARE\TriNet' -Name "$appVendor`_$AppName`_$AppVersion" -Value '1' -Type String -ContinueOnError:$True
		##*===============================================
		##* POST-UNINSTALLATION
		##*===============================================
